...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        af_out, af_cache = affine_forward(ar_out, W3, b3)
        scores = af_out
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        ############################################################################
        loss, dout = softmax_loss(af_out, y)
        
        dar, grads['W3'], grads['b3'] = affine_backward(dout, af_cache)
        dcrp, grads['W2'], grads['b2'] = affine_relu_backward(dar, ar_cache)
